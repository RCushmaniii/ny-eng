...
const $$PrivacyPolicy = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const entry = legalData.find((item) => item.slug === "en/privacy-policy");
  if (!entry) {
...
}, "C:/Users/Robert Cushman/.vscode/Projects/ny-eng/src/pages/en/legal/privacy-policy.astro", void 0);

const $$file = "C:/Users/Robert Cushman/.vscode/Projects/ny-eng/src/pages/en/legal/privacy-policy.astro";
const $$url = "/en/legal/privacy-policy";
