...
const $$WindsurfRules = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$WindsurfRules;
  const windsurfContent = await import('../../../chunks/WindsurfRules_DAGqeEw7.mjs');
  const markdownText = windsurfContent.default;
  const htmlContent = marked(markdownText);
  const frontmatter = {
    title: "Windsurf Rules",
    description: "Development rules and coding standards for the project",
...
}, "C:/Users/Robert Cushman/.vscode/Projects/ny-eng/src/pages/dev/docs/windsurf-rules.astro", void 0);

const $$file = "C:/Users/Robert Cushman/.vscode/Projects/ny-eng/src/pages/dev/docs/windsurf-rules.astro";
const $$url = "/dev/docs/windsurf-rules";
