import { s as serviceCategories } from './service-categories_D7Tx5oRf.mjs';
import { e as erikaTestimonial, a as emmanuelTestimonial, b as albertoTestimonial } from './alberto-testimonial_CCOlA144.mjs';
import { j as julioTestimonial, h as hugobTestimonial, a as andresTestimonial, b as andreaTestimonial } from './andrea-testimonial_BIhra1AV.mjs';
import { k as karlaTestimonial, h as hugolTestimonial } from './karla-testimonial_DyWgwJc7.mjs';
import { l as luislTestimonial, n as noeTestimonial, r as ricardoTestimonial, h as humbertoTestimonial, j as javierTestimonial, a as jonathanTestimonial, t as taniaTestimonial } from './noe-testimonial_xFdI90RU.mjs';
...
const testimonials = [
  ...
  },
  {
    ...
    shortContent: "Working with Robert has been one of the most impactful steps I’ve taken in advancing my professional communication as a CTO—his practical coaching helped me structure presentations for impact, handle impromptu speaking, and lead with confidence…",
...
Robert's coaching has not only enabled me to overcome these challenges but has also given me the confidence to present more professionally. Robert has provided guidance on presenting and publishing my work in a corporate environment and has also introduced me to, and facilitated my learning of, many cutting-edge topics that have positively impacted both my professional and personal life.`,
  ...
  {
    content: "With Robert's support, I became more fluent and natural when speaking English. This has helped me care for international patients more effectively and communicate clearly during medical discussions and travel. I've noticed my English-speaking patients feel more at ease and trust me more.",
  ...
  {
    content: "Robert helped me strengthen my English communication for high-stakes client interactions. I now feel confident managing legal conversations, explaining complex issues, and building trust with U.S. clients. It's made a significant difference in my day-to-day work consulting international clients.",
  ...
  {
    content: "Working with Robert gave me a much stronger command of business English. I lead meetings more confidently, communicate more clearly with international partners, and get better results across the board. Internally, our communication is smoother—and our suppliers notice the difference.",
...
With Robert's coaching, I've become more natural in conversations, better at structuring my explanations, and more persuasive in demos and follow-ups. It's made a clear difference in how I interact with clients and represent my company in English.`,
  ...
  {
    content: "The lessons with Robert have helped me develop confidence when speaking in meetings with English-speaking clients and prospects. They've also aided me in expanding my vocabulary and correcting grammatical errors.",
  ...
  Now, I feel more secure and fluent in my communication and I perform better in technical discussions and negotiations.`,
    shortContent: "Before working with Robert, I sometimes felt unsure presenting in English during high-stakes calls and real-time meetings with international customers…",
    author: "Tania Ruelas",
...
export { testimonialsByIndustry as a, industryLabels as i, publishedTestimonials as p, testimonials as t };
