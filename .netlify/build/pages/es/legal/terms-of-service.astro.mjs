...
const $$TermsOfService = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Base", $$Base, { "lang": "es", "tkey": tkey, "title": entry.data.seo?.title || entry.data.title, "description": entry.data.seo?.description || "" }, { "default": async ($$result2) => renderTemplate` ${renderComponent($$result2, "InnerHero", $$InnerHero, { "content": heroContent })} ${maybeRenderHead()}<article class="site-container--small mx-auto px-8 prose pb-base pt-16"> ${renderComponent($$result2, "Content", Content, {})} </article> ` })}`;
}, "C:/Users/Robert Cushman/.vscode/Projects/ny-eng/src/pages/es/legal/terms-of-service.astro", void 0);

const $$file = "C:/Users/Robert Cushman/.vscode/Projects/ny-eng/src/pages/es/legal/terms-of-service.astro";
const $$url = "/es/legal/terms-of-service";
