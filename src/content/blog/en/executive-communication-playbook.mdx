...
<img src="/images/blog/playbook/en/strategic-trajectory.png" alt="Strategic trajectory language framework showing how to reframe negative statements into forward-looking executive communication" class="rounded-lg shadow-md my-8 mx-auto" loading="lazy" />
...
<FlipCardGrid client:visible cards={[
  {
    question: "In Pillar 1, how does 'reactive language' typically describe a problem?",
    answer: "Reactive language reports the problem, explains what happened, and waits for someone else to set the direction — instead of signaling that you are in control."
  },
  {
    question: "What is the recommended trajectory language alternative for 'We lost two key clients'?",
    answer: "We experienced some portfolio adjustment, which has actually allowed us to concentrate resources on our highest-growth accounts."
  },
  {
    question: "What does it mean to 'diagnose the system, not the people' when raising concerns?",
    answer: "Framing issues as systemic or process-related gaps rather than personal failures — creating alignment instead of enemies."
  },
  {
    question: "Which phrase identifies the cost of inaction in executive persuasion?",
    answer: "\"The opportunity cost of not acting is...\" — one of the key persuasion phrases that frames decisions around what's lost by not investing."
  },
  {
    question: "What is the difference between an 'information-sharer' and a 'storyteller' in executive meetings?",
    answer: "Information-sharers list facts (data dump) and get polite nods, while storytellers build a narrative arc and get their proposals approved."
  }
]} />
...
<img src="/images/blog/playbook/en/the-goal.png" alt="The goal of executive communication — commanding influence and authority in English" class="rounded-lg shadow-md my-8 mx-auto" loading="lazy" />
...
<img src="/images/blog/playbook/en/stop learning start leading.png" alt="Stop learning English, start leading in English — the mindset shift for executive communication" class="rounded-lg shadow-md my-8 mx-auto" loading="lazy" />
