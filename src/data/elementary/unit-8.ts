  ...
  connectors: [
    {
      ...
      wordEs: "usualmente",
      example: {
        english: "I usually wake up at 6:30.",
        spanish: "Usualmente me despierto a las 6:30.",
      },
    },
    {
      word: "always",
      wordEs: "siempre",
      example: {
        english: "I always drink coffee first.",
        spanish: "Siempre tomo café primero.",
      },
    },
    {
      word: "every day",
      wordEs: "cada día",
      example: {
        english: "I check my email every day.",
        spanish: "Reviso mi correo cada día.",
      },
    },
    {
      ...
      example: {
        ...
        spanish: "Hago ejercicio tres veces a la semana.",
      },
    },
    {
      word: "sometimes",
      wordEs: "a veces",
      example: {
        english: "Sometimes I work from a coffee shop.",
        spanish: "A veces trabajo desde una cafetería.",
      },
    },
    {
      word: "rarely",
      ...
      example: {
        ...
        spanish: "Casi nunca veo televisión.",
      },
    },
  ],
  bossSentence: {
