...
export const allMemeEntries: MemeEntry[] = [
  ...
  // ========================================================================
  {
    ...
    captionEs:
      "Pasaste 3 días diseñándolo. Ellos pasaron 3 segundos leyendo la descripción del PR.",
    ...
    afterPhraseEs:
      "Me gustaría explorar un patrón alternativo que pueda escalar mejor para nuestra carga proyectada.",
    imagePrompt:
    ...
    altTextEs:
      "Meme sobre la reacción de un ingeniero cuando cuestionan su arquitectura de código en revisión",
  ...
  },
  {
    ...
    afterPhraseEs:
      "Identificamos un caso borde en el flujo de pagos -- la corrección está en progreso y actualizaré al equipo al final del día.",
    imagePrompt:
    ...
    altTextEs:
      "Meme sobre lidiar con preguntas inesperadas de seguimiento durante un standup de tecnología",
  ...
  },
  {
    ...
    titleEs: "Explicando la Deuda Técnica a Stakeholders No Técnicos",
    captionEn:
      "When the VP asks 'Why does this simple feature take 3 sprints?' and you have to explain 5 years of architectural choices.",
    captionEs:
      "Cuando el VP pregunta 'Por qué esta función simple toma 3 sprints?' y tienes que explicar 5 años de decisiones arquitectónicas.",
    beforePhraseEn: "The code is a mess. Someone built it wrong.",
    beforePhraseEs: "El código es un desastre. Alguien lo construyó mal.",
    afterPhraseEn:
    ...
    afterPhraseEs:
      "Hemos acumulado deuda técnica estratégica que ahora impacta la velocidad de entrega. Preparé un plan de remediación que equilibra nuevas funcionalidades con mejoras de estabilidad.",
    imagePrompt:
    ...
    altTextEs:
      "Meme sobre la complejidad oculta detrás de solicitudes de funcionalidades simples y deuda técnica",
  ...
  },
  {
    ...
    captionEs:
      "Es 'sin culpa' pero de alguna manera todos te están mirando.",
    beforePhraseEn:
    ...
    afterPhraseEs:
      "Permítanme explicar la secuencia de eventos y nuestro análisis de causa raíz. Ya redacté medidas preventivas para revisión del equipo.",
    imagePrompt:
    ...
    altTextEs:
      "Meme sobre la tensión entre la cultura de postmortem sin culpa y sentirse personalmente responsable",
  ...
  },
  {
    ...
    captionEs:
      "Cada 'arreglo rápido' es un refactor de 3 sprints disfrazado.",
    ...
    afterPhraseEs:
      "Basándonos en nuestros datos de velocidad, recomendaría dividir esto en dos sprints para mantener la calidad. Así es como desglosaría los entregables.",
    imagePrompt:
    ...
    altTextEs:
      "Meme del iceberg mostrando la complejidad oculta detrás de solicitudes de funcionalidades simples en desarrollo de software",
  ...
  },
  {
    ...
    beforePhraseEs:
      "Su equipo nos está bloqueando. No podemos avanzar.",
    afterPhraseEn:
    ...
    afterPhraseEs:
      "Me gustaría alinear el cronograma de dependencias para desbloquear los flujos de trabajo paralelos. Podríamos coordinar una reunión breve para mapear los hitos de integración?",
    imagePrompt:
  ...
  },
  {
    ...
    captionEs:
      "Puedes debuggear un sistema distribuido en producción pero pedir un aumento te hace olvidar el inglés.",
    ...
    afterPhraseEs:
      "Basándome en mis contribuciones a la migración de plataforma y la reducción del 40% en tiempo de respuesta a incidentes, me gustaría discutir mi trayectoria hacia el nivel de ingeniero senior.",
    imagePrompt:
    ...
    altTextEs:
      "Meme contrastando la confianza de un ingeniero debuggeando código versus el nerviosismo pidiendo un aumento",
  ...
  },
  {
    ...
    titleEs: "Cuando el CEO Pregunta 'Qué Hace Tu Equipo Realmente?'",
    captionEn:
    ...
    beforePhraseEs:
      "Estamos migrando a una plataforma de orquestación containerizada con capacidades de service mesh.",
    afterPhraseEn:
    ...
    afterPhraseEs:
      "Estamos modernizando nuestra infraestructura para que las nuevas funcionalidades se lancen el doble de rápido y las caidas del sistema disminuyan un 60%. La inversión se paga sola en Q3.",
    imagePrompt:
    ...
    altTextEs:
      "Meme sobre ingenieros luchando por explicar trabajo técnico a ejecutivos no técnicos",
  ...
  // ========================================================================
  {
    ...
    titleEs: "Solo Una Función Más",
    captionEn:
      "The stakeholder says 'small change.' The Gantt chart screams.",
    captionEs:
      "El stakeholder dice 'cambio pequeño.' El diagrama de Gantt grita.",
    beforePhraseEn: "That's not in the scope.",
    beforePhraseEs: "Eso no está en el alcance.",
    afterPhraseEn:
    ...
    altTextEs:
      "Meme mostrando cómo un pequeño cambio de alcance destruye todo un cronograma de proyecto",
  ...
  },
  {
    ...
    titleEs: "La Actualización de Estado Que Nadie Quiere Dar",
    captionEn:
      "When the project is 'on track' the way a plane with one engine is 'still flying.'",
    captionEs:
      "Cuando el proyecto va 'en camino' de la misma forma que un avión con un motor 'todavía vuela.'",
    ...
    afterPhraseEs:
      "Ajustamos el cronograma para tener en cuenta la complejidad de la integración del API. Aquí está nuestro plan de recuperación con tres hitos contra los que verán avances semanalmente.",
    imagePrompt:
  ...
  },
  {
    ...
    titleEs: "Por Favor Señor, Puedo Tener Otro Desarrollador?",
    captionEn:
      "When your 'team of five' is actually 2.5 FTE after shared resources and PTO.",
    captionEs:
      "Cuando tu 'equipo de cinco' en realidad es 2.5 FTE después de recursos compartidos y vacaciones.",
    beforePhraseEn: "We need more people on this project.",
    beforePhraseEs: "Necesitamos más personas en este proyecto.",
    afterPhraseEn:
    ...
    afterPhraseEs:
      "Para mantener la calidad y cumplir con la fecha de Q3, recomendaría aumentar el equipo con dos ingenieros. Aquí está el modelo de capacidad mostrando el impacto.",
    imagePrompt:
  ...
  },
  {
    ...
    afterPhraseEs:
      "Estoy planteando esto proactivamente: aquí está el riesgo, la probabilidad, el impacto al negocio, y tres opciones de mitigación ordenadas por costo y efectividad.",
    imagePrompt:
  ...
  },
  {
    ...
    titleEs: "Prometer Menos, Entregar Más (Accidentalmente Invertido)",
    captionEn:
      "When sales promised the client 'everything' and now it's your timeline.",
    captionEs:
      "Cuando ventas le prometió al cliente 'todo' y ahora es tu cronograma.",
    ...
    afterPhraseEs:
      "Esto es lo que podemos entregar para el viernes con calidad completa, y aquí hay un enfoque por fases para realizar la visión completa en las próximas 6 semanas.",
    imagePrompt:
    ...
    altTextEs:
      "Meme sobre la brecha entre las promesas de ventas y la realidad de gestión de proyectos",
  ...
  },
  {
    ...
    titleEs: "Esta Reunión Podria Haber Sido un Email",
    captionEn:
      "45 minutes of 'aligning' and nobody can articulate what was decided.",
    captionEs:
      "45 minutos de 'alineación' y nadie puede articular qué se decidió.",
    beforePhraseEn: "We need to make a decision right now.",
    beforePhraseEs: "Necesitamos tomar una decisión ahora mismo.",
    afterPhraseEn:
    ...
    afterPhraseEs:
      "Permítanme enmarcar los criterios de decisión y las dos opciones para que podamos alinearnos eficientemente. Capturaré el resultado y las acciones a seguir por escrito.",
    imagePrompt:
  ...
  },
  {
    ...
    captionEs:
      "Tres equipos. Cero dueños. Un PM tratando de mantener todo junto con una matriz RACI y una oración.",
    ...
    afterPhraseEs:
      "Permítanme clarificar el RACI para cerrar la brecha de responsabilidad. Redactaré una propuesta y la tendré lista para revisión mañana.",
    imagePrompt:
    ...
    altTextEs:
      "Meme sobre el PM atrapado en el medio cuando ningún equipo es dueño de la brecha cross-funcional",
  ...
  },
  {
    ...
    titleEs: "La Diapositiva de ROI Que Salvó el Proyecto",
    captionEn:
      "CFO: 'Why should we spend money on this?' PM: *pulls out the spreadsheet they've been building since 2 AM*",
    captionEs:
      "CFO: 'Por qué deberíamos gastar dinero en esto?' PM: *saca la hoja de cálculo que ha estado construyendo desde las 2 AM*",
    beforePhraseEn:
      "We just need more budget to finish the project.",
    beforePhraseEs:
      "Solo necesitamos más presupuesto para terminar el proyecto.",
    afterPhraseEn:
    ...
    afterPhraseEs:
      "El análisis de ROI muestra que una inversión de $50K ahora ahorra $200K en retrabajo. Aquí está el modelo con escenarios conservadores y optimistas.",
    imagePrompt:
    ...
    altTextEs:
      "Meme sobre el viaje del PM desde análisis de datos nocturno hasta presentación de ROI lista para ejecutivos",
  ...
  // ========================================================================
  {
    ...
    titleEs: "Explicando la Brecha Sin Causar Pánico",
    captionEn:
      "Somewhere between 'everything is fine' and 'update your resume' lies the truth.",
    captionEs:
      "En algún lugar entre 'todo está bien' y 'actualiza tu currículum' está la verdad.",
    ...
    afterPhraseEs:
      "Detectamos acceso no autorizado, lo contuvimos en 20 minutos, y estamos ejecutando nuestro plan de respuesta a incidentes. Informaré al equipo ejecutivo a las 3 PM con una evaluación completa.",
    imagePrompt:
    ...
    altTextEs:
      "Meme sobre gerentes de IT manteniéndose calmados mientras comunican incidentes de seguridad a ejecutivos en pánico",
  ...
  },
  {
    ...
    captionEs:
      "El 'descuento especial' del proveedor es solo el precio del año pasado con un nuevo PDF.",
    ...
    afterPhraseEs:
      "Basándonos en un análisis competitivo de tres proveedores, nos gustaría discutir precios por volumen que reflejen el valor de nuestra asociación a largo plazo y trayectoria de crecimiento.",
    imagePrompt:
  ...
  },
  {
    ...
    titleEs: "Nadie Lee el Email de Migración",
    captionEn:
      "You sent 5 emails, hosted 3 training sessions, and Karen from accounting still can't find her files.",
    captionEs:
      "Enviaste 5 emails, organizaste 3 sesiones de capacitación, y Karen de contabilidad todavía no encuentra sus archivos.",
    beforePhraseEn:
    ...
    afterPhraseEs:
      "Diseñamos un despliegue por fases con soporte de capacitación dedicado y un canal de mesa de ayuda. Los líderes de departamento impulsarán la adopción dentro de sus equipos.",
    imagePrompt:
  ...
  },
  {
    ...
    titleEs: "La Actualización de Promoción de Codigo Que Realmente Significa Algo",
    captionEn:
      "'Mostly done' is not a deployment status. Your team deserves specifics, not vibes.",
    captionEs:
      "'Casi listo' no es un estado de despliegue. Tu equipo merece específicos, no vibras.",
    beforePhraseEn: "I think it's mostly done.",
    beforePhraseEs: "Creo que está casi listo.",
    afterPhraseEn:
      "Core build is complete. QA is testing edge cases.",
    afterPhraseEs:
      "La compilación principal está completa. QA está probando casos borde.",
    imagePrompt:
    ...
    altTextEs:
      "Meme de antes y después de un gerente de IT dando una actualización de promoción de código — de vago a preciso y profesional",
  ...
  },
  {
    ...
    titleEs: "La Evaluación de Desempeño Que Realmente Ayuda",
    captionEn:
      "The gap between 'you need to improve' and actually helping someone improve could fit an entire career.",
    captionEs:
      "La brecha entre 'necesitas mejorar' y realmente ayudar a alguien a mejorar podría abarcar toda una carrera.",
    beforePhraseEn:
      "Your performance needs improvement in several areas.",
    beforePhraseEs:
      "Tu desempeño necesita mejora en varias áreas.",
    afterPhraseEn:
    ...
    afterPhraseEs:
      "Veo un gran potencial en tu trabajo de automatización. Creemos un plan de crecimiento enfocado en expandir tus habilidades de arquitectura cloud -- puedo conectarte con un mentor del equipo de plataforma.",
    imagePrompt:
    ...
    altTextEs:
      "Meme contrastando evaluaciones de desempeño vagas con conversaciones de desarrollo específicas orientadas al crecimiento",
  ...
  },
  {
    ...
    captionEs:
      "La utilización está al 87%. El CFO pregunta 'Pero ya se rompió?' y mueres un poco por dentro.",
    beforePhraseEn:
    ...
    afterPhraseEs:
      "Atender esto ahora reduce el riesgo de una interrupción mayor.",
    imagePrompt:
    ...
    altTextEs:
      "Meme de antes y después de un gerente de IT reaccionando a un error crítico en la sala de servidores — del pánico a la comunicación profesional de riesgos",
  ...
  },
  {
    ...
    titleEs: "No, No Puedes Instalar Esa Extensión de Chrome",
    captionEn:
    ...
    beforePhraseEs: "No puedes hacer eso. Es contra la política.",
    afterPhraseEn:
    ...
    afterPhraseEs:
      "Nuestro marco de seguridad requiere este paso de aprobación para proteger a la empresa. Permíteme ayudarte a encontrar una alternativa que cumpla con las normas y satisfaga tus necesidades -- puedo tenerla lista para mañana.",
    imagePrompt:
  ...
  },
  {
    ...
    beforePhraseEs:
      "IT está funcionando bien. Todo está trabajando bien.",
    afterPhraseEn:
    ...
    afterPhraseEs:
      "IT entregó 99.7% de disponibilidad este trimestre, reduciendo el tiempo de resolución por ticket en un 18% y completando la migración a la nube dentro del presupuesto -- ahorrando $180K anuales.",
    imagePrompt:
    ...
    altTextEs:
      "Meme comparando reportes técnicos de IT que duermen ejecutivos versus resúmenes de impacto de negocio que los enganchan",
  ...
  // ========================================================================
  {
    ...
    captionEs:
      "Hay una razón por la que 'me encantaría conocer tu opinión' tiene un 0.3% de tasa de respuesta.",
    beforePhraseEn:
      "Hi, I'd love to tell you about our product. Can we schedule a call?",
    beforePhraseEs:
      "Hola, me encantaría contarte sobre nuestro producto. Podemos agendar una llamada?",
    afterPhraseEn:
      "I noticed your team recently expanded into LATAM -- we helped a similar company reduce onboarding time by 40% during their expansión. Would a 15-minute conversation be valuable?",
    afterPhraseEs:
      "Note que tu equipo recientemente se expandió a LATAM -- ayudamos a una empresa similar a reducir el tiempo de onboarding un 40% durante su expansión. Sería valiosa una conversación de 15 minutos?",
    imagePrompt:
    ...
    altTextEs:
      "Meme contrastando mensajes genéricos de ventas en LinkedIn que son ignorados versus outreach personalizado que obtiene respuestas",
  ...
  },
  {
    ...
    titleEs: "Cuando Dicen 'Su Competidor Es Más Barato'",
    captionEn:
      "Yes, and a bicycle is cheaper than a car. Different vehicle, different destination.",
    captionEs:
      "Si, y una bicicleta es más barata que un auto. Diferente vehículo, diferente destino.",
    beforePhraseEn:
      "But our solution has more features and better support.",
    beforePhraseEs:
      "Pero nuestra solución tiene más funcionalidades y mejor soporte.",
    afterPhraseEn:
    ...
    afterPhraseEs:
      "Entiendo que el presupuesto es una prioridad. Permítame mostrarle la comparación del costo total de propiedad a 3 años -- incluyendo tiempo de implementación, mantenimiento, y el impacto en ingresos de un despliegue más rápido.",
    imagePrompt:
    ...
    altTextEs:
      "Meme sobre reformular objeciones de precio con análisis de costo total de propiedad",
  ...
  },
  {
    ...
    captionEs:
      "Cada descuento que das hoy se convierte en la base para la negociación de mañana.",
    ...
    afterPhraseEs:
      "Puedo estructurar un paquete que entregue más valor dentro de sus parámetros de presupuesto. Si ajustamos el cronograma de implementación, puedo incluir onboarding premium al mismo nivel de inversión.",
    imagePrompt:
    ...
    altTextEs:
      "Meme sobre cómo dar un descuento crea una avalancha de expectativas de descuentos futuros",
  ...
  },
  {
    ...
    captionEs:
      "VP: 'Qué pasó?' Tu: *intenta explicar sin decir 'nos dejaron en visto'*",
    ...
    afterPhraseEs:
      "Completamos nuestro análisis post-negocio e identificamos tres hallazgos: alineación de tiempos, una brecha en nuestro posicionamiento de mercado medio, y la ventaja de soporte local del competidor. Estoy aplicando estos aprendizajes a dos oportunidades activas.",
    imagePrompt:
    ...
    altTextEs:
      "Meme sobre convertir el análisis de negocios perdidos en perspectivas prácticas para la próxima oportunidad",
  ...
  },
  {
    ...
    beforePhraseEs:
      "Creemos que esto podría potencialmente impulsar el engagement.",
    afterPhraseEn:
    ...
    altTextEs:
      "Meme de antes y después de un ejecutivo de ventas presentando valor — de titubeos vagos a afirmaciones confiadas y específicas",
  ...
  },
  {
    ...
    titleEs: "Convirtiendo un Cliente Furioso en un Caso de Éxito",
    captionEn:
      "The fastest way to build trust is to fix something spectacularly after it breaks spectacularly.",
    captionEs:
      "La forma más rápida de construir confianza es arreglar algo espectacularmente después de que se rompe espectacularmente.",
    beforePhraseEn:
    ...
    afterPhraseEs:
      "Reconocí el impacto, asumí responsabilidad con sus stakeholders, y presenté un plan de resolución con un cronograma comprometido. Me gustaría agendar un seguimiento para confirmar que todo va por buen camino.",
    imagePrompt:
    ...
    altTextEs:
      "Meme mostrando el viaje de crisis con cliente a testimonio brillante a traves de recuperación estructurada",
  ...
  },
  {
    ...
    titleEs: "Mi Pronóstico Es Preciso (Esta Vez Lo Prometo)",
    captionEn:
      "When your VP asks for your 'honest forecast' but your job depends on the number being high enough.",
    captionEs:
      "Cuando tu VP pide tu 'pronóstico honesto' pero tu trabajo depende de que el número sea suficientemente alto.",
    ...
    afterPhraseEs:
      "Basándome en un análisis ponderado del pipeline, pronóstico $2.1M con un 85% de confianza. Los tres negocios que impulsan esto están en etapa de propuesta con fechas de decisión confirmadas por los champions.",
    imagePrompt:
    ...
    altTextEs:
      "Meme sobre la diferencia entre pronósticos de ventas por instinto y análisis ponderado de pipeline basado en datos",
  ...
  },
  {
    ...
    beforePhraseEs:
      "Eh, entonces, como, vamos a, um, quizás probar esta nueva cosa de CRM? Es, ya saben, para los datos... creo? Perdón...",
    afterPhraseEn:
    ...
    afterPhraseEs:
      "Equipo, este nuevo CRM es un cambio total! Va a optimizar nuestro proceso de ventas, nos dara mejores insights, y llevara nuestro éxito a nuevas alturas. Abracemos este futuro juntos!",
    imagePrompt:
    ...
    altTextEs:
      "Meme de antes y después mostrando a un gerente de ventas pasando de una presentación torpe e insegura del CRM a una presentación inspiradora y segura para el equipo",
  ...
  // ========================================================================
  {
    ...
    titleEs: "La Junta Quiere una Historia, No una Hoja de Cálculo",
    captionEn:
      "34% YoY growth sounds great until someone asks you to explain it in English during Q&A.",
    captionEs:
      "34% de crecimiento interanual suena genial hasta que alguien te pide explicarlo en inglés durante las preguntas.",
    beforePhraseEn: "The company is doing well. Revenue is up.",
    beforePhraseEs: "La empresa va bien. Los ingresos subieron.",
    afterPhraseEn:
      "We achieved 34% year-over-year growth driven by three strategic pillars: geographic expansión, product-led growth, and enterprise account penetration. Here's our roadmap to sustained acceleration through Q4.",
    afterPhraseEs:
      "Logramos un 34% de crecimiento interanual impulsado por tres pilares estratégicos: expansión geográfica, crecimiento liderado por producto y penetración de cuentas empresariales. Aquí está nuestro plan para una aceleración sostenida hasta Q4.",
    imagePrompt:
  ...
  },
  {
    ...
    titleEs: "Liderando en el Caos Sin Verse Caótico",
    captionEn:
      "The building is metaphorically on fire but your voice needs to be the fire extinguisher.",
    captionEs:
      "El edificio está metafóricamente en llamas pero tu voz necesita ser el extintor.",
    beforePhraseEn:
      "We have a serious problem and I'm not sure what to do yet.",
    beforePhraseEs:
      "Tenemos un problema serio y no estoy seguro de qué hacer todavía.",
    afterPhraseEn:
    ...
    afterPhraseEs:
      "Quiero ser transparente sobre un desafío que estamos navegando. Aquí está nuestra evaluación, las acciones ya en marcha, y el cronograma para la resolución. Los actualizaremos en estos tres hitos.",
    imagePrompt:
    ...
    altTextEs:
      "Meme sobre ejecutivos manteniendo la compostura durante comunicación de crisis mientras el caos ocurre en el fondo",
  ...
  },
  {
    ...
    titleEs: "Vendiendo la Visión Sin el Bingo de Palabras de Moda",
    captionEn:
      "When your strategy deck has more 'disruption' than data, investors start disrupting themselves... out the door.",
    captionEs:
      "Cuando tu presentación estratégica tiene más 'disrupción' que datos, tus inversores empiezan a disrumpirse... hacia la salida.",
    beforePhraseEn:
      "We should expand into new markets. There's a big opportunity.",
    beforePhraseEs:
      "Deberíamos expandirnos a nuevos mercados. Hay una gran oportunidad.",
    afterPhraseEn:
    ...
    afterPhraseEs:
      "El análisis de mercado indica una oportunidad direccionable de $50M en LATAM. Aquí está la tesis de inversión: tres ventajas competitivas, la estrategia de entrada, y el camino de 18 meses a la rentabilidad.",
    imagePrompt:
    ...
    altTextEs:
      "Meme sobre reemplazar el bingo de palabras de moda estratégicas con datos reales de mercado y tesis de inversión",
  ...
  },
  {
    ...
    captionEs:
      "La diferencia entre un líder y un jefe es lo que pasa en la oración después de 'necesitamos hablar.'",
    beforePhraseEn:
    ...
    afterPhraseEs:
      "Valoro tus contribuciones, especialmente tu trabajo en el lanzamiento de Q2. Alineemos objetivos específicos que te posicionen para la vía de director -- quiero invertir en tu crecimiento aquí.",
    imagePrompt:
    ...
    altTextEs:
      "Meme sobre la diferencia entre crítica desmoralizante y feedback ejecutivo constructivo orientado al crecimiento",
  ...
  },
  {
    ...
    titleEs: "Haciendo que los Inversores Crean Antes de que los Números Lo Hagan",
    captionEn:
    ...
    captionEs:
      "El product-market fit es hermoso. Explicarlo en inglés a inversores que hablan fluido escepticismo -- ese es el verdadero desafío.",
    beforePhraseEn:
      "We need more funding to grow the company.",
    beforePhraseEs:
      "Necesitamos más financiamiento para hacer crecer la empresa.",
    afterPhraseEn:
    ...
    afterPhraseEs:
      "Nuestras métricas demuestran product-market fit: 140% de retención neta de ingresos, periodo de recuperación de 3 meses, y un run rate de $2M ARR. Esta ronda acelera nuestro camino a la rentabilidad para Q4 del próximo año.",
    imagePrompt:
    ...
    altTextEs:
      "Meme contrastando pitches vagos de startups que fallan versus pitches basados en métricas que cierran rondas de financiamiento",
  ...
  },
  {
    ...
    captionEs:
      "La palabra 'sinergias' en una presentación de M&A tiene un 90% de correlación con 'en realidad no hemos descifrado esto todavía.'",
    beforePhraseEn:
      "We should buy this company. They're a good fit.",
    beforePhraseEs:
      "Deberíamos comprar esta empresa. Son un buen fit.",
    afterPhraseEn:
    ...
    afterPhraseEs:
      "La tesis de adquisición se basa en tres sinergias: su talento de ingeniería llena nuestra brecha de plataforma, su base de clientes nos da distribución en EMEA, y la I+D combinada elimina $8M en gasto duplicado. Aquí está el cronograma de integración de 90 días.",
    imagePrompt:
    ...
    altTextEs:
      "Meme sobre la diferencia entre afirmaciones vagas de sinergia en M&A y tesis de adquisición específicas y cuantificadas",
  ...
  },
  {
    ...
    titleEs: "El Town Hall Que No Necesitó un Seguimiento de Control de Danos",
    captionEn:
      "When times are tough, employees don't need optimism -- they need a leader who tells the truth AND shows the path forward.",
    captionEs:
      "Cuando los tiempos son difíciles, los empleados no necesitan optimismo -- necesitan un líder que diga la verdad Y muestre el camino hacia adelante.",
    beforePhraseEn:
      "Times are tough but we'll get through this.",
    beforePhraseEs:
      "Los tiempos son difíciles pero saldremos adelante.",
    afterPhraseEn:
    ...
    afterPhraseEs:
      "Quiero ser honesto sobre los desafíos que enfrentamos -- e igualmente claro sobre por qué confío en nuestro camino hacia adelante. Aquí hay tres acciones específicas que estamos tomando y cómo cada uno de ustedes contribuye a nuestra recuperación.",
    imagePrompt:
    ...
    altTextEs:
      "Meme sobre comunicación ejecutiva en town halls que equilibra honestidad sobre desafíos con un camino claro hacia adelante",
  ...
  },
  {
    ...
    captionEs:
      "La pregunta del reportero es una trampa. Tu respuesta es un puente. Donde terminas depende de tu inglés ejecutivo.",
    ...
    afterPhraseEs:
      "Lo que nos diferencia es nuestro enfoque en implementación basada en resultados. Permítame darle un ejemplo concreto: un cliente redujo sus costos operativos en un 35% en 90 días usando nuestra metodología.",
    imagePrompt:
    ...
    altTextEs:
      "Meme sobre la diferencia entre frases genericas para medios y respuestas ejecutivas específicas basadas en historias",
  ...
  // ========================================================================
  {
    ...
    titleEs: "Día de Pitch: La Pronunciación",
    captionEn:
    ...
    altTextEs:
      "Meme sobre fundadores de startups tropezando con términos clave de negocios en inglés durante pitches a inversores",
  ...
  },
  {
    ...
    titleEs: "Explicando Tu Burn Rate Con Cara Sería",
    captionEn:
      "Investor: 'What's your runway?' You: *mentally converts months to something that sounds less terrifying*",
    captionEs:
      "Inversor: 'Cuál es tu runway?' Tu: *mentalmente convierte meses a algo que suene menos aterrador*",
    beforePhraseEn: "We're spending money fast but we'll figure it out.",
    beforePhraseEs: "Estamos gastando dinero rápido pero lo resolveremos.",
    afterPhraseEn:
    ...
    altTextEs:
      "Meme sobre el contraste entre el pánico financiero interno de un fundador y su presentación compuesta ante inversores",
  ...
  },
  {
    ...
    titleEs: "La Conversación de 'Alineación' con el Cofundador",
    captionEn:
      "You both said 'I agree' in the meeting. You both meant completely different things.",
    captionEs:
      "Ambos dijeron 'estoy de acuerdo' en la reunión. Ambos quisieron decir cosas completamente diferentes.",
    beforePhraseEn: "I think we disagree on the direction. This isn't working.",
    beforePhraseEs: "Creo que no estamos de acuerdo en la dirección. Esto no está funcionando.",
    afterPhraseEn:
    ...
    afterPhraseEs:
      "Quiero asegurarme de que estemos alineados en la prioridad estratégica para Q2. Permíteme compartir mi perspectiva, luego me encantaría escuchar la tuya, y encontraremos el punto en común.",
    imagePrompt:
    ...
    altTextEs:
      "Meme sobre cofundadores que están de acuerdo en palabras pero quieren decir cosas completamente diferentes sobre la dirección de la empresa",
  ...
  },
  {
    ...
    afterPhraseEs:
      "Serás dueño del roadmap completo del producto desde el día uno. En esta etapa, cada decisión que tomes moldea la empresa. Además, tu paquete de equity está estructurado para que los primeros empleados capturen el mayor beneficio.",
    imagePrompt:
    ...
    altTextEs:
      "Meme sobre fundadores de startups compitiendo por talento contra grandes empresas tech con visión en lugar de salario",
  ...
  },
  {
    ...
    afterPhraseEs:
      "Gran pregunta. Nuestro costo de adquisición de clientes es $45, el valor de por vida es $380, dandonos un ratio LTV-a-CAC de 8.4x. Alcanzamos el payback en 3 meses.",
    imagePrompt:
    ...
    altTextEs:
      "Meme sobre el contraste entre la confianza ensayada del pitch de un fundador y su pánico durante las preguntas no guionadas de inversores",
  ...
  },
  {
    ...
    captionEs:
      "La idea original falló. Ahora necesitas decirle a tus inversores que fue 'evolución estratégica' todo el tiempo.",
    beforePhraseEn: "The first idea didn't work so we're trying something different.",
    beforePhraseEs: "La primera idea no funcióno así que estamos intentando algo diferente.",
    afterPhraseEn:
    ...
    afterPhraseEs:
      "El descubrimiento de clientes revelo una tracción más fuerte hacia el caso de uso adyacente. Nos reposicionamos para capturar esa demanda -- misma tecnología, mercado más grande, y nuestros tres primeros clientes de pago validaron el movimiento.",
    imagePrompt:
    ...
    altTextEs:
      "Meme sobre fundadores reformulando pivotes como evolución estratégica al presentar ante inversores",
  ...
  },
  {
    ...
    captionEs:
      "Se supone que debes escuchar pain points. En cambio, estás traduciendo mentalmente la pregunta que quieres hacer después.",
    ...
    afterPhraseEs:
      "Cuéntame que pasa cuando te encuentras con este problema hoy. Cuál es la mayor frustración? Y que valdría resolverlo para tu equipo?",
    imagePrompt:
  ...
  },
  {
    ...
    titleEs: "El Comunicado de Prensa del Día de Lanzamiento Que Nadie Lee",
    captionEn:
      "You spent 3 weeks perfecting the English in your press release. TechCrunch summarized it in one wrong sentence.",
    captionEs:
      "Pasaste 3 semanas perfeccionando el inglés de tu comunicado de prensa. TechCrunch lo resumió en una oración incorrecta.",
    beforePhraseEn: "We're excited to announce the launch of our revolutionary platform.",
    beforePhraseEs: "Estamos emocionados de anunciar el lanzamiento de nuestra plataforma revoluciónaria.",
    afterPhraseEn:
    ...
    afterPhraseEs:
      "Hoy lanzamos la primera herramienta que permite a equipos de logística reducir el tiempo de procesamiento aduanal en un 70%. Tres clientes empresariales ya están en vivo. Aquí hay un demo de 60 segundos.",
    imagePrompt:
    ...
    altTextEs:
      "Meme sobre la brecha entre el comunicado de prensa cuidadosamente escrito de un fundador y cómo los medios realmente lo cubren",
  ...
  // ========================================================================
  {
    ...
    captionEs:
      "El envío tiene 3 semanas de retraso. El asunto de tu email dice 'Actualización de Ajuste de Cronograma.'",
    beforePhraseEn: "The shipment is delayed. We don't know when it will arrive.",
    beforePhraseEs: "El envío está retrasado. No sabemos cuándo llegará.",
    afterPhraseEn:
    ...
    afterPhraseEs:
      "Identificamos un problema de congestión portuaria que afecta el ETA. La llegada revisada actual es el 15 de marzo. Activé nuestro transportista de respaldo como contingencia y los actualizaré el viernes con estatus confirmado.",
    imagePrompt:
    ...
    altTextEs:
      "Meme sobre gerentes de logística encontrando formas creativas de comunicar retrasos de envío profesionalmente",
  ...
  },
  {
    ...
    titleEs: "Documentación Aduanal: El Nivel Final del Inglés",
    captionEn:
    ...
    afterPhraseEs:
      "Tenemos una discrepancia en la documentación del bill of lading -- los detalles del consignatario no coinciden con la carta de credito. Estoy coordinando con el freight forwarder para emitir un BL corregido para hoy.",
    imagePrompt:
    ...
    altTextEs:
      "Meme sobre el desafío de navegar la compleja terminología aduanal en inglés en envíos internacionales",
  ...
  },
  {
    ...
    titleEs: "Negociando Con Transportistas Que Saben Que Estás Desesperado",
    captionEn:
    ...
    captionEs:
      "Las tarifas de temporada alta se triplicaron. El transportista sabe que tienes 200 contenedores esperando. Tu cara de poker nunca ha sido más importante.",
    ...
    afterPhraseEs:
      "Valoramos la asociación y queremos encontrar una estructura de tarifas que funcione para ambas partes a largo plazo. Basándonos en nuestro compromiso de volumen de 200+ TEU mensuales, esto es lo que muestra el benchmarking competitivo para esta ruta.",
    imagePrompt:
    ...
    altTextEs:
      "Meme sobre gerentes de logística manteniendo el poder de negociación con transportistas durante temporada alta",
  ...
  },
  {
    ...
    titleEs: "El Cliente Quiere 'Más Rápido' Pero No Pagara Flete Aereo",
    captionEn:
      "Client: 'Can we speed this up?' You: 'Yes. It costs 10x more.' Client: '...Can we speed it up for free?'",
    captionEs:
      "Cliente: 'Podemos acelerar esto?' Tú: 'Sí. Cuesta 10x más.' Cliente: '...Podemos acelerarlo gratis?'",
    beforePhraseEn: "We can't go faster unless you pay for air freight.",
    beforePhraseEs: "No podemos ir más rápido a menos que pagues por flete aéreo.",
    afterPhraseEn:
    ...
    afterPhraseEs:
      "Preparé tres opciones: flete marítimo con cronograma estándar, marítimo express con una mejora de 5 días, y flete aéreo para entrega urgente. Aquí está el costo-beneficio de cada uno para que pueda decidir basándose en sus necesidades de inventario.",
    imagePrompt:
      "A speed slíder graphic: On the left it says 'OCEAN (cheap, slow)' and on the right 'AIR (fast, expensive).' A client's hand is trying to drag the slíder to 'fast' while simultaneously pointing at the 'cheap' end. A logistics manager watches with a patient but knowing expression. The universal logistics dilemma visualized. Clean infographic-style humor.",
    altTextEn:
      "Meme about clients wanting faster shipping without paying premium rates for air freight",
    altTextEs:
      "Meme sobre clientes que quieren envíos más rápidos sin pagar tarifas premium de flete aéreo",
  ...
  },
  {
    ...
    captionEs:
      "Cuando un contenedor llega dañado a las 3 AM y necesitas escribir un email profesional de reclamo en inglés antes de que tu cafe haga efecto.",
    beforePhraseEn: "The container arrived damaged. We need someone to fix this immediately.",
    beforePhraseEs: "El contenedor llego dañado. Necesitamos que alguien arregle esto inmediatamente.",
    afterPhraseEn:
    ...
    afterPhraseEs:
      "El contenedor MSKU-4521890 llego con daños por agua en aproximadamente el 30% de la carga. Documenté los daños con fotos con marca de tiempo, presenté el reclamo preliminar de seguro, y coordiné con el almacén para segregar las unidades afectadas. La evaluación completa de daños estara lista al mediodía.",
    imagePrompt:
    ...
    altTextEs:
      "Meme sobre profesionales de logística manejando reclamos por daños de carga a las 3 AM con inglés profesional",
  ...
  },
  {
    ...
    captionEs:
      "Una palabra incorrecta en la declaración de exportación y tu envío está en aduanas por 3 semanas.",
    beforePhraseEn: "There's a compliance issue with the shipment. I'm not sure what happened.",
    beforePhraseEs: "Hay un problema de cumplimiento con el envío. No estoy seguro de qué pasó.",
    afterPhraseEn:
    ...
    afterPhraseEs:
      "Identificamos una discrepancia de clasificación en la declaración de exportación -- se aplicó el código HS 8471.30 en lugar de 8471.41. Presenté la enmienda ante aduanas y espero el despacho dentro de 48 horas.",
    imagePrompt:
    ...
    altTextEs:
      "Meme sobre cómo un pequeño error en documentación aduanal crea una reacción en cadena de problemas logísticos",
  ...
  },
  {
    ...
    titleEs: "La Reunión con el Proveedor Donde Asientes Pero No Entiendes",
    captionEn:
    ...
    captionEs:
      "El proveedor está hablando de Incoterms y estás 80% seguro de que dijo 'FOB' pero pudo haber sido 'FOP' y ahora tienes miedo de preguntar.",
    ...
    afterPhraseEs:
      "Solo para asegurarme de que estamos alineados -- están proponiendo FOB Shanghai, lo que significa que el riesgo se transfiere a nosotros una vez que la carga cruza la borda del barco. Pueden confirmar que los cargos de carga están incluidos de su lado?",
    imagePrompt:
    ...
    altTextEs:
      "Meme sobre profesionales de logística asintiendo en discusiones de Incoterms que no entienden completamente en inglés",
  ...
  },
  {
    ...
    captionEs:
      "La realidad: 6 contenedores atascados, 2 transportistas que no responden, y un almacén al 97% de capacidad. El resumen ejecutivo: 'Ajustes operacionales menores en progreso.'",
    beforePhraseEn: "Supply chain is having a lot of problems right now.",
    beforePhraseEs: "La cadena de suministro está teniendo muchos problemas ahora.",
    afterPhraseEn:
    ...
    afterPhraseEs:
      "Estamos manejando tres disrupciones concurrentes: congestión portuaria en Shanghai afectando 6 contenedores, una restricción de capacidad de transportistas en la ruta Asia-LATAM, y utilización elevada del almacén al 97%. Aquí está el plan de mitigación con cronogramas para cada una.",
    imagePrompt:
    ...
    altTextEs:
      "Meme sobre la brecha entre el caos operacional de la cadena de suministro y el resumen ejecutivo calmado que se envía hacia arriba",
  ...
  // ========================================================================
  {
    ...
    captionEs:
      "En algún lugar entre 'No eres lo suficientemente bueno' y 'Nos encantó todo de ti pero no' está el email de rechazo profesional.",
    ...
    afterPhraseEs:
      "Después de una consideración cuidadosa, avanzamos con un candidato cuya experiencia se alinea más estrechamente con este rol específico. Tu experiencia en ingeniería de datos nos impresionó -- me encantaría mantener contacto para futuras oportunidades que se alineen mejor con tus fortalezas.",
    imagePrompt:
  ...
  },
  {
    ...
    titleEs: "Negociación Salarial: La Danza de los Números",
    captionEn:
      "Candidate: 'What's the salary range?' You: *tries to answer without actually answering*",
    captionEs:
      "Candidato: 'Cuál es el rango salarial?' Tu: *intenta responder sin realmente responder*",
    beforePhraseEn: "We can't go higher than that. The budget is fixed.",
    beforePhraseEs: "No podemos ir más alto. El presupuesto es fijo.",
    afterPhraseEn:
    ...
    afterPhraseEs:
      "El rango salarial base para este rol es $85-95K. Dada tu experiencia de 7 años y las certificaciones cloud, puedo posicionarte hacia el tope de ese rango. Permíteme también explicarte la compensación total incluyendo equity, estructura de bonos y presupuesto de desarrollo profesional.",
    imagePrompt:
    ...
    altTextEs:
      "Meme sobre las negociaciones salariales siendo una danza estructurada entre componentes de compensación total en lugar de una confrontación",
  ...
  },
  {
    ...
    titleEs: "El Plan de Mejora de Desempeño Que a Nadie Le Gusta Escribir",
    captionEn:
      "HR's least favorite document to write in English, and the employee's least favorite to receive in any language.",
    captionEs:
      "El documento menos favorito de RRHH para escribir en inglés, y el menos favorito del empleado para recibir en cualquier idioma.",
    beforePhraseEn: "You're on a PIP. You have 30 days to fix these issues or we'll let you go.",
    beforePhraseEs: "Estás en un PIP. Tienes 30 días para arreglar estos problemas o te dejaremos ir.",
    afterPhraseEn:
    ...
    afterPhraseEs:
      "Este plan está diseñado para apoyar tu éxito. Aquí hay tres objetivos específicos y medibles para los próximos 30 días, los recursos disponibles para ayudarte, y la cadencia de seguimiento. Quiero verte tener éxito en este rol.",
    imagePrompt:
    ...
    altTextEs:
      "Meme sobre reformular planes de mejora de desempeño de documentos punitivos a marcos de crecimiento de apoyo",
  ...
  },
  {
    ...
    captionEs:
      "Cada empresa dice 'gran cultura.' Los candidatos que han sido quemados antes necesitan específicos, no vibras.",
    beforePhraseEn: "We have an amazing culture. We're like a family here.",
    beforePhraseEs: "Tenemos una cultura increíble. Somos como una familia aquí.",
    afterPhraseEn:
    ...
    afterPhraseEs:
      "Nuestro equipo de ingeniería hace releases semanales con 90% de autonomía en decisiones técnicas. Tenemos una política de miércoles sin reuniones, 20% del tiempo para proyectos personales, y nuestro último score de engagement fue 4.2 de 5. Aquí está lo que tres ingenieros actuales dijeron sobre su experiencia.",
    imagePrompt:
    ...
    altTextEs:
      "Meme sobre reemplazar cliches genéricos de marca empleadora con puntos de prueba de cultura específicos y medibles",
  ...
  },
  {
    ...
    captionEs:
      "Dos semanas de aviso: cuando los empleados finalmente se sienten lo suficientemente seguros para dar la retroalimentación real.",
    ...
    afterPhraseEs:
      "Aprecio tu honestidad durante esta conversación. Los patrones que describes sobre visibilidad de promociones y comunicación de gerentes son cosas que quiero abordar. Puedo compartir estos temas -- anonimizados -- con el equipo de liderazgo para impulsar un cambio real?",
    imagePrompt:
    ...
    altTextEs:
      "Meme sobre las entrevistas de salida siendo el único momento en que los empleados dan retroalimentación verdaderamente honesta sobre la cultura de la empresa",
  ...
  },
  {
    ...
    captionEs:
      "Plantilla de mensaje de reclutador #47: 'Oportunidad emocionante!' Tasa de eliminación: 99.7%.",
    beforePhraseEn: "Hi! I have an exciting opportunity that would be perfect for you. Let's chat!",
    beforePhraseEs: "Hola! Tengo una oportunidad emocionante que sería perfecta para ti. Hablemos!",
    afterPhraseEn:
    ...
    afterPhraseEs:
      "Vi tu charla en ReactConf sobre manejo de estado -- tu enfoque para reducir re-renders fue impresionante. Estamos construyendo un equipo que aborda exactamente ese tipo de desafío de performance a escala. Estarías abierto a una conversación de 10 minutos sobre lo que estamos construyendo?",
    imagePrompt:
    ...
    altTextEs:
      "Meme sobre la diferencia entre spam genérico de reclutadores y outreach personalizado y basado en investigación hacia candidatos",
  ...
  },
  {
    ...
    captionEs:
      "Ambos lados creen que tienen razón. Necesitas encontrar palabras neutrales en inglés que no accidentalmente se pongan del lado de ningúno.",
    beforePhraseEn: "You both need to work this out. Just communicate better.",
    beforePhraseEs: "Ambos necesitan resolver esto. Solo comúniquense mejor.",
    afterPhraseEn:
    ...
    afterPhraseEs:
      "He escuchado ambas perspectivas y veo preocupaciones legítimas de ambos lados. Permítanme reflejar lo que estoy escuchando para que podamos encontrar un punto en común. El objetivo es un acuerdo de trabajo que aborde tanto las necesidades de flujo de trabajo del equipo como los requisitos de flexibilidad.",
    imagePrompt:
    ...
    altTextEs:
      "Meme sobre profesionales de RRHH mediando conflictos laborales encontrando lenguaje neutral y puntos en común",
  ...
  },
  {
    ...
    titleEs: "Presentando el Programa de Capacitación Sin Disculparte por Ello",
    captionEn:
      "You know the program will transform leadership. Now say it like you believe it.",
    captionEs:
      "Sabes que el programa transformará el liderazgo. Ahora dilo como si lo creyeras.",
    ...
    beforePhraseEs: "Eh, um, tal vez, si está bien, podríamos, como, probar este nuevo programa de capacitación ejecutiva? Eh, podría ser bueno, creo? Perdón...",
    afterPhraseEn:
    ...
    afterPhraseEs:
      "Estamos implementando este nuevo programa de capacitación ejecutiva. Impulsara resultados de liderazgo y es crucial para nuestro crecimiento futuro. Comenzamos la próxima semana.",
    imagePrompt:
    ...
    altTextEs:
      "Meme de antes y después de una oficial de RRHH presentando un programa de capacitación ejecutiva — de titubear con incertidumbre a liderazgo seguro",
  ...
  // ========================================================================
  {
    ...
    afterPhraseEs:
      "Permítame simplificar esto en un framework. Si mapeamos urgencia contra valor estratégico, sus iniciativas caen en cuatro cuadrantes. La esquina superior derecha es donde debemos enfocarnos primero -- alta urgencia, alto valor. Aquí está mi secuencia recomendada.",
    imagePrompt:
    ...
    altTextEs:
      "Meme sobre consultores usando matrices 2x2 para simplificar problemas complejos de negocios en marcos prácticos",
  ...
  },
  {
    ...
    titleEs: "Scope Creep Disfrazado de 'Una Pregunta Más'",
    captionEn:
      "The client said 'quick question' 47 times. Each one added a week to the project.",
    captionEs:
      "El cliente dijo 'pregunta rápida' 47 veces. Cada una agregó una semana al proyecto.",
    beforePhraseEn: "Sure, I can look into that too. No problem.",
    beforePhraseEs: "Claro, también puedo revisar eso. No hay problema.",
    afterPhraseEn:
    ...
    afterPhraseEs:
      "Gran pregunta -- eso en realidad está fuera del alcance del engagement actual, pero es un area importante. Recomendaría que lo capturemos para un flujo de trabajo de Fase 2. Permítame redactar un breve adendum de alcance para que podamos abordarlo adecuadamente sin impactar los entregables actuales.",
    imagePrompt:
    ...
    altTextEs:
      "Meme sobre cómo cada 'pregunta rápida' del cliente se convierte en una bola de nieve de scope creep masivo en engagements de consultoría",
  ...
  },
  {
    ...
    captionEs:
      "La mejor consultoría es cuando el cliente dice 'Eso es exactamente lo que estaba pensando' sobre la idea por la que te contrataron.",
    beforePhraseEn: "Based on our analysis, you should do X.",
    beforePhraseEs: "Basándome en nuestro análisis, deberían hacer X.",
    afterPhraseEn:
    ...
    afterPhraseEs:
      "Los datos confirman lo que su equipo ha estado sintiendo: la oportunidad en LATAM es real. Lo que nuestro análisis agrega es el dimensionamiento -- $12M de mercado direccionable -- y un playbook de entrada probado de tres empresas comparables. Su instinto era correcto; ahora tienen la evidencia para avanzar.",
    imagePrompt:
    ...
    altTextEs:
      "Meme sobre el arte de consultoría de validar las intuiciones del cliente con datos para que las recomendaciones se sientan como conclusiones naturales",
  ...
  },
  {
    ...
    titleEs: "La Presentación de Entregables en Inglés Imperfecto",
    captionEn:
    ...
    captionEs:
      "El análisis es brillante. El diseño de las diapositivas es perfecto. Y luego abres la boca y de repente 'synergistic value proposition' tiene demasiadas sílabas.",
    beforePhraseEn: "So, um, this slide shows that, well, the company should maybe consider...",
    beforePhraseEs: "Entonces, um, esta diapositiva muestra que, bueno, la empresa debería quizás considerar...",
    afterPhraseEn:
    ...
    afterPhraseEs:
      "Esta diapositiva captura nuestro hallazgo principal: están dejando $3M en ahorros anuales sobre la mesa debido a fragmentación en compras. La solución tiene tres fases. Permítame explicarles cada fase y el ROI esperado.",
    imagePrompt:
    ...
    altTextEs:
      "Meme sobre consultores superando la ansiedad de presentación en inglés simplificando el lenguaje y enfocandose en insights",
  ...
  },
  {
    ...
    captionEn:
      "They hired you for your honest opinión. They meant 'honest opinión that agrees with ours.'",
    captionEs:
      "Te contrataron por tu opinión honesta. Quisieron decir 'opinión honesta que concuerde con la nuestra.'",
    beforePhraseEn: "I think your current approach isn't working.",
    beforePhraseEs: "Creo que su enfoque actual no está funcionando.",
    afterPhraseEn:
      "The current go-to-market strategy has generated strong brand awareness, which is valuable. Where the data shows a gap is in conversión -- 0.8% versus the 2.5% industry benchmark. I'd like to present an alternative approach that preserves your brand positioning while addressing the conversión gap.",
    afterPhraseEs:
      "La estrategia go-to-market actual ha generado un fuerte reconocimiento de marca, lo cual es valioso. Donde los datos muestran una brecha es en conversión -- 0.8% versus el benchmark de la industria de 2.5%. Me gustaría presentar un enfoque alternativo que preserve su posicionamiento de marca mientras aborda la brecha de conversión.",
    imagePrompt:
    ...
    altTextEs:
      "Meme sobre consultores entregando verdades difíciles empezando con fortalezas antes de abordar las brechas",
  ...
  },
  {
    ...
    titleEs: "Facilitación de Talleres: Pastoreando Gatos en Inglés",
    captionEn:
      "8 stakeholders, 8 opinions, 3 languages in the room, and you need to reach 'alignment' in 90 minutes.",
    captionEs:
      "8 stakeholders, 8 opiniones, 3 idiomas en la sala, y necesitas llegar a 'alineación' en 90 minutos.",
    ...
    afterPhraseEs:
      "Tenemos 90 minutos y tres decisiones que tomar. Enmarcaré cada decisión con las opciones y trade-offs, usaremos votación por puntos para identificar preferencias, y sintetizaré la dirección del grupo. Suena bien? Comencemos con la decisión de mayor impacto.",
    imagePrompt:
    ...
    altTextEn:
      "Meme about consultants bringing structure and process to chaotic stakeholder workshops with diverse opinións",
    altTextEs:
      "Meme sobre consultores trayendo estructura y proceso a talleres caóticos de stakeholders con opiniones diversas",
  ...
  },
  {
    ...
    captionEs:
      "El proyecto terminó. La pregunta es: te vuelven a llamar, o buscan en Google 'consultor más barato'?",
    beforePhraseEn: "That wraps up our engagement. Let me know if you need anything else.",
    beforePhraseEs: "Eso concluye nuestro engagement. Avísame si necesitas algo más.",
    afterPhraseEn:
    ...
    afterPhraseEs:
      "Al cerrar la Fase 1, aquí está el resumen ejecutivo de valor entregado: $2.4M en ahorros identificados, un roadmap de 3 años que tu equipo puede ejecutar independientemente, y los talleres de construcción de capacidades que realizamos. Basándome en lo que descubrimos, veo dos áreas naturales donde podríamos agregar valor. Me encantaría discutirlas cuando estés listo.",
    imagePrompt:
  ...
  },
  {
    ...
    captionEs:
      "Hay dos tipos de whitepapers de consultoría: los que cambian el pensamiento y los que descarga una vez la mama del autor.",
    beforePhraseEn: "In today's rapidly changing business landscape, companies must embrace digital transformation.",
    beforePhraseEs: "En el panorama empresarial que cambia rápidamente hoy en dia, las empresas deben abrazar la transformación digital.",
    afterPhraseEn:
    ...
    afterPhraseEs:
      "El 73% de las empresas manufactureras de LATAM reportan que las brechas de comunicación en inglés les cuestan un promedio de $340K anuales en contratos retrasados y alianzas perdidas. Aquí están los datos de 200 empresas y tres estrategias que reducen ese costo a la mitad.",
    imagePrompt:
    ...
    altTextEs:
      "Meme sobre la diferencia entre liderazgo de pensamiento genérico de consultoría y contenido basado en datos que realmente se lee",
  ...
  // ========================================================================
  {
    ...
    captionEs:
      "Ventas quiere Feature A. Ingeniería quiere refactorizar. El CEO quiere AI. Tu roadmap de alguna manera necesita incluir los tres y lanzar ayer.",
    ...
    afterPhraseEs:
      "Nuestro roadmap está organizado en tres horizontes: H1 es autenticación empresarial -- desbloquea $800K en pipeline. H2 es el refactor del API -- reduce el trabajo repetitivo de ingeniería en 40%. H3 es la exploración de AI. Aquí están los datos detrás de la secuencia.",
    imagePrompt:
    ...
    altTextEs:
      "Meme sobre product managers balanceando prioridades de stakeholders en competencia con secuenciación de roadmap basada en datos",
  ...
  },
  {
    ...
    afterPhraseEs:
      "Aprecio la visión detrás de esta solicitud. El problema del usuario que aborda es real -- permíteme compartir lo que hemos aprendido sobre cómo nuestros principales usuarios lo resuelven hoy, y proponer una alternativa que logre el mismo resultado con la mitad de la inversión de ingeniería.",
    imagePrompt:
  ...
  },
  {
    ...
    titleEs: "Presentación de Investigación de Usuarios Que Cambia Mentes",
    captionEn:
      "You interviewed 30 users. The VP still says 'But I think users want...' Based on a sample size of one: themselves.",
    captionEs:
      "Entrevistaste 30 usuarios. El VP todavía dice 'Pero creo que los usuarios quieren...' Basandose en una muestra de uno: ellos mismos.",
    ...
    afterPhraseEs:
      "A través de 30 entrevistas con usuarios, encontramos tres patrones consistentes: el 78% abandona el flujo de onboarding en el paso 3, la razón principal es fatiga de formularios, y la mejora más solicitada es revelación progresiva. Permítanme reproducir dos clips de 30 segundos que ilustran el patrón.",
    imagePrompt:
    ...
    altTextEs:
      "Meme sobre product managers usando datos de investigación estructurados para contrarrestar suposiciones de stakeholders sobre necesidades de usuarios",
  ...
  },
  {
    ...
    titleEs: "Sprint Review: Lo Bueno, lo Malo, y el 'Lo Arreglaremos el Próximo Sprint'",
    captionEn:
      "The demo works perfectly... on localhost. In staging, it catches fire. The stakeholders are watching.",
    captionEs:
      "La demo funciona perfectamente... en localhost. En staging, se incendia. Los stakeholders están mirando.",
    beforePhraseEn: "The feature isn't quite ready yet. We had some issues.",
    beforePhraseEs: "La funcionalidad no está del todo lista todavía. Tuvimos algunos problemas.",
    afterPhraseEn:
    ...
    afterPhraseEs:
      "Este sprint lanzamos el flujo principal de autenticación -- pueden verlo funcionando aquí en la demo. Descubrimos un problema de rendimiento en staging que ya diagnosticamos. La corrección está programada para los primeros dos días del próximo sprint, así que el cronograma de lanzamiento se mantiene.",
    imagePrompt:
  ...
  },
  {
    ...
    titleEs: "Análisis Competitivo Sin Hablar Mal de la Competencia",
    captionEn:
      "The competitor's product is objectively worse. Saying that out loud, however, makes you look petty instead of strategic.",
    captionEs:
      "El producto del competidor es objetivamente peor. Decirlo en voz alta, sin embargo, te hace ver mezquino en lugar de estratégico.",
    ...
    afterPhraseEn:
      "Our differentiation is strongest in three áreas: implementation speed, API flexibility, and dedicated support. Here's a feature-by-feature comparison based on the evaluation criteria our enterprise buyers care about most.",
    afterPhraseEs:
      "Nuestra diferenciación es más fuerte en tres áreas: velocidad de implementación, flexibilidad de API, y soporte dedicado. Aquí hay una comparación funcionalidad por funcionalidad basada en los criterios de evaluación que más importan a nuestros compradores empresariales.",
    imagePrompt:
    ...
    altTextEs:
      "Meme sobre la diferencia entre crítica mezquina al competidor y posicionamiento competitivo estratégico basado en datos",
  ...
  },
  {
    ...
    titleEs: "Comunicación de Lanzamiento Que No Sobrepromete",
    captionEn:
    ...
    captionEs:
      "Marketing quiere 'revolucionario.' Ingeniería dice 'es un botón.' La verdad está en algún lugar intermedio, y necesitas escribir el email de lanzamiento.",
    beforePhraseEn: "We're excited to announce our amazing new feature that changes everything!",
    beforePhraseEs: "Estamos emocionados de anunciar nuestra increíble nueva funcionalidad que cambia todo!",
    afterPhraseEn:
    ...
    afterPhraseEs:
      "Hoy lanzamos importación masiva -- la funcionalidad #1 más solicitada por cuentas empresariales. Reduce el tiempo de procesamiento de CSV de 45 minutos a menos de 2 minutos. Aquí hay un recorrido de 60 segundos y los tres flujos de trabajo que mejora.",
    imagePrompt:
    ...
    altTextEs:
      "Meme sobre product managers encontrando el punto medio honesto entre el hype de marketing y la subestimación de ingeniería",
  ...
  },
  {
    ...
    afterPhraseEs:
      "Tres riesgos identificados. Planes de mitigación ya activados.",
    imagePrompt:
    ...
    altTextEs:
      "Meme de antes y después de un product manager presentando riesgos en la sala de juntas — de titubeos vagos a específicos y aplicables",
  ...
  },
  {
    ...
    titleEs: "Alineando Ingeniería y Diseño Cuando No Estan de Acuerdo",
    captionEn:
    ...
    captionEs:
      "Diseño quiere pixel-perfect. Ingeniería quiere lanzar rápido. Tu eres el traductor entre dos personas que ambas creen que la otra no entiende.",
    ...
    afterPhraseEs:
      "Escucho ambas perspectivas. Diseño, la calidad de la interacción importa porque impulsa la adopción. Ingeniería, la fecha de lanzamiento importa porque los clientes empresariales están esperando. Aquí hay una propuesta: lanzamos V1 con el flujo principal el jueves, e iteramos en las micro-interacciones en el release de seguimiento la próxima semana. Tanto la calidad como la velocidad se preservan.",
    imagePrompt:
    ...
    altTextEs:
      "Meme sobre product managers mediando entre el perfeccionismo de diseño y el pragmatismo de ingeniería con entrega por fases",
