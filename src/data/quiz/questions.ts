...
export const questionsEn: QuizQuestion[] = [
  {
    id: 1,
    question:
      "How often do misunderstandings with North American clients require follow-up clarification?",
    category: "clarity",
    options: [
  ...
  },
  {
    id: 2,
    question:
      "When presenting solutions to clients, how well does your team explain technical concepts in business terms?",
    category: "clarity",
    options: [
  ...
  },
  {
    id: 3,
    question:
      "During live client calls, how often does your team say 'Let me get back to you' when they actually know the answer?",
    category: "confidence",
    options: [
  ...
  },
  {
    id: 4,
    question:
      "When clients push back on scope, timeline, or pricing, how effectively does your team hold the line?",
    category: "negotiation",
    options: [
      {
        text: "Very effectively—they defend our position confidently",
        value: 10,
      },
      {
        text: "Moderately—they try but sometimes concede too quickly",
        value: 6,
      },
  ...
  },
  {
    id: 5,
    question:
      "How many team members can confidently lead a client meeting (not just attend)?",
    category: "leadership",
    options: [
  ...
  },
  {
    id: 6,
    question:
      "How comfortable is your team building rapport with North American clients beyond the technical discussion?",
    category: "confidence",
    options: [
...
export const questionsEs: QuizQuestion[] = [
  {
    id: 1,
    question:
      "¿Con qué frecuencia los malentendidos con clientes norteamericanos requieren aclaración de seguimiento?",
    category: "clarity",
    options: [
      {
        text: "Casi nunca—la comunicación es clara desde el principio",
        value: 10,
      },
  ...
  },
  {
    id: 2,
    question:
      "Al presentar soluciones a clientes, ¿qué tan bien explica tu equipo conceptos técnicos en términos de negocio?",
    category: "clarity",
    options: [
      {
        text: "Excelente—los clientes lo comprenden inmediatamente",
        value: 10,
      },
      { text: "Bueno—ocasionalmente necesita aclaración", value: 7 },
      {
        text: "Regular—los clientes piden regularmente explicaciones más simples",
        value: 4,
      },
  ...
  },
  {
    id: 3,
    question:
      "Durante llamadas en vivo con clientes, ¿con qué frecuencia tu equipo dice 'Déjame volver contigo' cuando en realidad saben la respuesta?",
    category: "confidence",
    options: [
      { text: "Nunca—responden en tiempo real", value: 10 },
      {
        text: "Rara vez—solo para detalles verdaderamente complejos",
        value: 7,
      },
  ...
  },
  {
    id: 4,
    question:
      "Cuando los clientes rechazan alcance, cronograma o precios, ¿qué tan efectivamente tu equipo mantiene la posición?",
    category: "negotiation",
    options: [
      {
        text: "Muy efectivamente—defienden nuestra posición con confianza",
        value: 10,
      },
      {
        text: "Moderadamente—lo intentan pero a veces ceden demasiado rápido",
        value: 6,
      },
  ...
  },
  {
    id: 5,
    question:
      "¿Cuántos miembros del equipo pueden liderar con confianza una reunión con clientes (no solo asistir)?",
    category: "leadership",
    options: [
      ...
      {
        text: "Ninguno—el liderazgo senior siempre debe estar presente",
        value: 0,
      },
    ],
  },
  {
    id: 6,
    question:
      "¿Qué tan cómodo está tu equipo construyendo rapport con clientes norteamericanos más allá de la discusión técnica?",
    category: "confidence",
    options: [
