...
export const pastTenseLessons: PastTenseLesson[] = [
  ...
  },
  {
    ...
    slugEs: "leccion-5",
    title: "Used to / Would",
    titleEs: "Used to / Would",
    tense: "It was a habit. It was who I was back then.",
    tenseEs: "Era un hábito. Era quien yo era en ese entonces.",
    subtitle: "The habitual past — the English version of solía and the imperfecto",
    subtitleEs: "El pasado habitual — la versión en inglés de solía y el imperfecto",
    icon: "Repeat",
    available: true,
  },
  {
    ...
    tense: "Putting all five together — like a native.",
    tenseEs: "Combinando los cinco — como un nativo.",
...
export const pastTenseBonuses: PastTenseBonus[] = [
  ...
  },
  {
    id: 6,
    slug: "practice-plan",
    slugEs: "plan-de-practica",
    title: "Your 30-Day Practice Plan",
    titleEs: "Tu Plan de Práctica de 30 Días",
    description: "How to install everything you learned into real speech: daily drills, what to watch/read, how to find a practice buddy.",
    descriptionEs: "Cómo instalar todo lo que aprendiste en el habla real: drills diarios, qué ver/leer, cómo encontrar un compañero de práctica.",
    icon: "Calendar",
    available: true,
  },
];
