...
export const unit7Sections: UnitSection[] = [
  ...
  },
  {
    ...
    whyEs: "Disentir mal crea enemigos. Evitar el desacuerdo crea malas decisiones. La habilidad ejecutiva es desafiar ideas sin atacar personas. Esta sección te da un marco repetible — Reconocer → Reencuadrar → Redirigir — que te permite contradecir con precisión y respeto.",
...
export const unit7Section1Drills: WeakStrongEliteItem[] = [
  ...
  },
  {
    ...
    elite: "I'd like each lead to brief us on their top risk and one recommendation. Start with the area closest to a deadline.",
    eliteEs: "Me gustaría que cada líder nos informe sobre su principal riesgo y una recomendación. Empiecen por el área más cercana a un plazo de entrega.",
...
export const unit7FinalShift: FinalShift = {
  ...
  afterEs: "Abres con propósito, mantienes la palabra con autoridad y disientes sin crear enemigos. La sala sigue tu estructura.",
};
