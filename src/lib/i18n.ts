...
export const routeFor: Record<Locale, Record<TKey, string>> = {
  en: {
    ...
    "legal/cancellation-policy": "/en/legal/cancellation-policy/",
    ...
    "category/pronunciation": "/en/category/pronunciation/",
    "category/corporate-english-training": "/en/category/corporate-english-training/",
    assessments: "/en/assessments/",
    quiz: "/en/quiz/",
    "quiz/start": "/en/quiz/it-services/",
    ...
    "course/beginners/unit-7": "/en/course/beginners/unit-7/",
  ...
  es: {
    ...
    "legal/cancellation-policy": "/es/legal/cancellation-policy/",
    ...
    "category/pronunciation": "/es/categoria/pronunciacion/",
    "category/corporate-english-training": "/es/categoria/capacitacion-de-ingles-corporativo/",
    assessments: "/es/assessments/",
    quiz: "/es/quiz/",
    "quiz/start": "/es/quiz/it-services/",
    ...
    "course/beginners/unit-7": "/es/curso/principiantes/unidad-7/",
...
export function getAllTKeys(): TKey[] {
  return [
    ...
    "category/corporate-english-training",
    "assessments",
    "quiz",
    "quiz/start",
    "quiz/results",
